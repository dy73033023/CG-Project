...
// -- 두더지 -- (폭탄)
MultiTextureObject BombMoleBodyAndHandObject; // 몸통과 손
MultiTextureObject BombMoleEyeAndMustacheObject; // 눈과 콧수염
MultiTextureObject BombMoleNailObject; // 손톱
MultiTextureObject BombMoleNoseObject; // 코
MultiTextureObject BombMoleNoseTipObject; // 코 끝
MultiTextureObject BombMoleBombObject; // 폭탄
MultiTextureObject BombMoleFuseObject; // 도화선
MultiTextureObject BombMoleXmarkObject; // 폭탄 X 마크
...
// -- 두더지 -- (폭탄)
std::vector<GLuint> BombMoleBodyAndHandTextureIds; // 몸통과 손
std::vector<GLuint> BombMoleEyeAndMustacheTextureIds; // 눈과 콧수염
std::vector<GLuint> BombMoleNailTextureIds; // 손톱
std::vector<GLuint> BombMoleNoseTextureIds; // 코
std::vector<GLuint> BombMoleNoseTipTextureIds; // 코 끝
std::vector<GLuint> BombMoleBombTextureIds; // 폭탄
std::vector<GLuint> BombMoleFuseTextureIds; // 도화선
std::vector<GLuint> BombMoleXmarkTextureIds; // 폭탄 X 마크
